...
def ios_application_test_suite():
    ...
    infoplist_contents_test(
        ...
        target_under_test = "@build_bazel_rules_apple//test/starlark_tests/targets_under_test/ios:app",
        expected_values = {
            "BuildMachineOSBuild": "*",
    ...
    infoplist_contents_test(
        ...
        target_under_test = "@build_bazel_rules_apple//test/starlark_tests/targets_under_test/ios:app_multiple_infoplists",
        expected_values = {
