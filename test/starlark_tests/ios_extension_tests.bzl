...
def ios_extension_test_suite():
    ...
    infoplist_contents_test(
        ...
        target_under_test = "@build_bazel_rules_apple//test/starlark_tests/targets_under_test/ios:ext",
        expected_values = {
            "BuildMachineOSBuild": "*",
    ...
    infoplist_contents_test(
        ...
        target_under_test = "@build_bazel_rules_apple//test/starlark_tests/targets_under_test/ios:ext_multiple_infoplists",
        expected_values = {
